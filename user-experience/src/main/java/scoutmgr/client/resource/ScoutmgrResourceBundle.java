...
{
  interface BootstrapCss
    extends CssResource
  {
    @ClassName( "glyphicon-bold" )
    String glyphiconBold();

    @ClassName( "glyphicon-envelope" )
    String glyphiconEnvelope();

    @ClassName( "glyphicon-tint" )
    String glyphiconTint();

    @ClassName( "glyphicon-leaf" )
    String glyphiconLeaf();

    @ClassName( "glyphicon-volume-down" )
    String glyphiconVolumeDown();
    ...
    @ClassName( "glyphicon-hand-right" )
    String glyphiconHandRight();
    ...
    @ClassName( "glyphicon-play-circle" )
    String glyphiconPlayCircle();
    ...
    @ClassName( "col-lg-offset-7" )
    String colLgOffset7();

    @ClassName( "col-lg-offset-8" )
    String colLgOffset8();

    @ClassName( "glyphicon-share-alt" )
    String glyphiconShareAlt();
    ...
    @ClassName( "glyphicon-arrow-up" )
    String glyphiconArrowUp();
    ...
    String glyphiconLogIn();

    @ClassName( "glyphicon-refresh" )
    String glyphiconRefresh();

    @ClassName( "glyphicon-pause" )
    String glyphiconPause();

    @ClassName( "glyphicon-map-marker" )
    String glyphiconMapMarker();

    @ClassName( "alert-success" )
    String alertSuccess();

    @ClassName( "glyphicon-fullscreen" )
    String glyphiconFullscreen();
    ...
    @ClassName( "col-lg-offset-11" )
    String colLgOffset11();

    @ClassName( "glyphicon-arrow-left" )
    String glyphiconArrowLeft();

    @ClassName( "col-lg-offset-10" )
    String colLgOffset10();

    @ClassName( "glyphicon-sort-by-attributes" )
    String glyphiconSortByAttributes();
    ...
    @ClassName( "glyphicon-euro" )
    String glyphiconEuro();

    @ClassName( "text-primary" )
    String textPrimary();

    @ClassName( "glyphicon-minus" )
    String glyphiconMinus();

    @ClassName( "glyphicon-tasks" )
    String glyphiconTasks();
    ...
    @ClassName( "col-lg-pull-10" )
    String colLgPull10();

    @ClassName( "glyphicon-road" )
    String glyphiconRoad();
    ...
    @ClassName( "glyphicon-align-justify" )
    String glyphiconAlignJustify();

    @ClassName( "glyphicon-minus-sign" )
    String glyphiconMinusSign();
    ...
    @ClassName( "col-md-pull-6" )
    String colMdPull6();

    @ClassName( "col-md-pull-3" )
    String colMdPull3();
    ...
    @ClassName( "col-md-pull-7" )
    String colMdPull7();

    @ClassName( "col-md-pull-8" )
    String colMdPull8();

    @ClassName( "col-md-offset-11" )
    String colMdOffset11();

    @ClassName( "col-md-offset-10" )
    String colMdOffset10();
    ...
    @ClassName( "glyphicon-phone" )
    String glyphiconPhone();
    ...
    String glyphiconThumbsDown();

    @ClassName( "glyphicon-sd-video" )
    String glyphiconSdVideo();

    @ClassName( "glyphicon-move" )
    String glyphiconMove();
    ...
    String glyphiconDownload();

    @ClassName( "glyphicon-wrench" )
    String glyphiconWrench();

    @ClassName( "glyphicon-plus-sign" )
    String glyphiconPlusSign();

    @ClassName( "glyphicon-italic" )
    String glyphiconItalic();

    @ClassName( "glyphicon-save" )
    String glyphiconSave();
    ...
    String glyphiconListAlt();

    @ClassName( "glyphicon-arrow-down" )
    String glyphiconArrowDown();
    ...
    @ClassName( "glyphicon-cutlery" )
    String glyphiconCutlery();
    ...
    @ClassName( "col-sm-push-9" )
    String colSmPush9();

    @ClassName( "col-sm-push-7" )
    String colSmPush7();

    @ClassName( "col-sm-push-8" )
    String colSmPush8();

    @ClassName( "col-sm-push-5" )
    String colSmPush5();
    ...
    @ClassName( "glyphicon-sort-by-order-alt" )
    String glyphiconSortByOrderAlt();
    ...
    @ClassName( "col-md-push-9" )
    String colMdPush9();

    @ClassName( "glyphicon-fast-backward" )
    String glyphiconFastBackward();

    @ClassName( "col-md-push-6" )
    String colMdPush6();

    @ClassName( "col-md-push-7" )
    String colMdPush7();
    ...
    @ClassName( "glyphicon-link" )
    String glyphiconLink();
    ...
    @ClassName( "glyphicon-dashboard" )
    String glyphiconDashboard();

    @ClassName( "glyphicon-filter" )
    String glyphiconFilter();

    @ClassName( "nav-pills" )
    String navPills();

    @ClassName( "glyphicon-collapse-up" )
    String glyphiconCollapseUp();

    @ClassName( "btn-group-sm" )
    String btnGroupSm();

    @ClassName( "glyphicon-asterisk" )
    String glyphiconAsterisk();
    ...
    @ClassName( "col-md-offset-8" )
    String colMdOffset8();

    @ClassName( "col-md-offset-7" )
    String colMdOffset7();

    @ClassName( "glyphicon-expand" )
    String glyphiconExpand();
    ...
    @ClassName( "glyphicon-volume-off" )
    String glyphiconVolumeOff();
    ...
    @ClassName( "glyphicon-sound-dolby" )
    String glyphiconSoundDolby();
    ...
    @ClassName( "glyphicon-sort-by-order" )
    String glyphiconSortByOrder();
    ...
    @ClassName( "glyphicon-hand-down" )
    String glyphiconHandDown();

    @ClassName( "glyphicon-repeat" )
    String glyphiconRepeat();
  ...
  @Source( value = { "bootstrap.gss", "bootstrap_overrides.gss" } )
